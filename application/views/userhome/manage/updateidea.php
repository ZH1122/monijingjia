        ...
        <div class="col-lg-6">
            <div class=" panel panel-default">
                ...
                <div class="panel-body">
                    <form  role="form" action="<?php echo base_url().'index.php/userhome/uhmanageidea/updateIdea';?>" method="post">
                        <?php foreach($data as $row):?>
                            <input type="text" style="display:none" value="<?php echo $row['idea_id'];?>" id="idea_id" name="idea_id" required="required" />
                        ...
                        <div class="form-group  has-feedback" id="idea_titlepearent">
                            ...
                            <input type="text" class="form-control input-lg" id="idea_title" name="idea_title" placeholder="标题字符在2-20之间" maxlength="20" value="<?php echo $row['idea_title'];?>">
                        ...
                        <div class="form-group has-feedback" id="idea_urlpearent">
                            ...
                            <input type="text" class="form-control input-lg" id="idea_url" name="idea_url" placeholder="请填写可访问的url" value="<?php echo $row['idea_url'];?>" maxlength="30">
                        ...
                        <div class="form-group has-feedback" id="idea_describrpearent">
                            ...
                            <textarea class="form-control" id="idea_describr" name="idea_describr" rows="3" placeholder="标题描述在2-80之间" maxlength="80" ><?php echo $row['idea_describr'];?></textarea>
                            <span id="state_describr" class="glyphicon form-control-feedback"></span>
                        </div>
                        <input  type="submit" class="btn btn-default submit input-lg" name="updateideasubmit">
